...
export const locations: LocationData[] = [
  {
    ...
    body: "Shadows is out now — the first taste of Dear Joshua.\n\nThe full EP lands August 21. And I'm playing one show in LA on August 8 — location TBA.",
  ...
  },
  {
    ...
    showLabel: true,
    headline: 'PRESS & EPK.',
    body: "Press, partners, and industry rooms. Everything you need — bio, photos, links.",
  ...
  },
  {
    ...
    body: "Soju and stage lights. Grab the mic and sing Dear Joshua back to me.",
  ...
  },
  {
    ...
    body: "Visuals from the Dear Joshua era — the EP is out August 21.",
  ...
  },
  {
    ...
    body: "The hills above Hollywood. Joni's ghost, Cass's house — the songs that made me.",
  ...
  },
  {
    ...
    body: "Corbin Bowl. Every Dear Joshua track is its own game — come play the EP early. Out August 21.",
  ...
  },
  {
    ...
    body: "The closet on the floor. Pick your favorite look ♥",
  ...
  },
  {
    ...
    body: "Before the world knows. Before the algorithm decides — you get it here first.",
  ...
  },
  {
    ...
    headline: 'B-SIDES.',
    body: "Demos, alternates, and behind-the-scenes — straight from the SoundCloud.",
