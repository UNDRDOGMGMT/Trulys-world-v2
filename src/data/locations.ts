...
export const locations: LocationData[] = [
  {
    ...
    caseLabel: 'CASE FILE: HOLLYWOOD',
    x: 50, y: 17,
    xPortrait: 50, yPortrait: 27,
    showLabel: true,
    headline: 'SHADOWS — OUT NOW',
    body: "Shadows is the first cut. A thing that bleeds in the daylight.\n\nThen Dear Joshua. Six rooms I built. Six confessions you weren't supposed to find.",
    ...
    environment: {
      ...
      views: [
        ...
        { id: 'vista', label: 'The Vista', src: '/world/maps/hw-vista.jpg', action: { label: 'Hear Shadows', to: '/shadows' } },
  ...
  },
  {
    id: 'dtla',
    name: 'DTLA',
    neighborhood: 'Cruise Night / After Dark',
    caseLabel: 'CASE FILE: DTLA',
    x: 70, y: 50,
    xPortrait: 76, yPortrait: 60,
    showLabel: true,
    headline: 'CRUISE NIGHT.',
    body: "1:14 AM. Grand Ave empty. The black Macan idling — plate still says TRULY, back-left fender still wrecked.\n\nPick a route. Collect the tapes. Try not to add to the scratches.",
  ...
  },
  {
    ...
    caseLabel: 'CASE FILE: BEVERLY HILLS',
    x: 30, y: 42,
    xPortrait: 38, yPortrait: 44,
    showLabel: true,
    headline: 'RODEO IS A CONFESSION.',
    body: "Press calls. Industry rooms. The version of me they want.\n\nThis is the file they read before they meet me.",
    cta: { label: 'PRESS KIT', href: '/press' },
  ...
  },
  {
    id: 'koreatown',
    name: 'Koreatown',
    neighborhood: 'After Hours / Karaoke',
    caseLabel: 'CASE FILE: KOREATOWN',
    x: 50, y: 58,
    xPortrait: 58, yPortrait: 48,
    showLabel: true,
    headline: 'AFTER HOURS.',
    body: "Soju and stage lights. The version that won't sleep.\n\nKaraoke confessions and the songs you weren't supposed to know.",
  ...
  },
  {
    ...
    name: 'West Hollywood',
    neighborhood: 'Merch',
    caseLabel: 'CASE FILE: WEHO',
    x: 25, y: 35,
    xPortrait: 32, yPortrait: 38,
    headline: 'LIMITED DROPS. HIGH IDENTITY.',
    body: "The closet I keep rebuilding. Dress me like it's a Tuesday ♥",
  ...
  },
  {
    ...
    caseLabel: 'CASE FILE: SANTA MONICA',
    x: 10, y: 50,
    xPortrait: 17, yPortrait: 43,
    headline: 'LIVING ROOM SESSIONS',
    body: "Stripped moments. Just the voice, the room, and whatever truth comes out.",
  ...
  },
  {
    ...
    name: 'Venice',
    neighborhood: 'Videos',
    caseLabel: 'CASE FILE: VENICE',
    x: 30, y: 65,
    xPortrait: 22, yPortrait: 58,
    headline: 'WATCH THE WORLD MOVE.',
    body: "Visuals from the Dear Joshua universe. Every frame is a room you can't leave.",
  ...
  },
  {
    ...
    caseLabel: 'CASE FILE: SILVERLAKE',
    x: 55, y: 38,
    xPortrait: 76, yPortrait: 44,
    headline: 'THE INNER CIRCLE.',
    body: "This is where you bring your versions. Covers, edits, confessions. We see you.",
  ...
  },
  {
    id: 'laurel-canyon',
    name: 'Laurel Canyon',
    neighborhood: 'Songbook / Influences',
    caseLabel: 'CASE FILE: LAUREL CANYON',
    x: 55, y: 18,
    xPortrait: 72, yPortrait: 22,
    showLabel: true,
    headline: 'WHERE I LEARNED TO WRITE.',
    body: "The hills above Hollywood. Joni's ghost. Cass's house.\n\nThis is the file of who taught me.",
  ...
  },
  {
    id: 'the-valley',
    name: 'The Valley',
    neighborhood: 'Lore / Diary',
    caseLabel: 'CASE FILE: THE VALLEY',
    x: 85, y: 24,
    xPortrait: 50, yPortrait: 12,
    headline: 'THE LORE.',
    body: "A surreal castle. Endless rooms. Love as a trap you step into willingly.\n\nThe Dear Joshua world isn't fiction. It's a confession engine. Every track is a room. Every room has a door that locks behind you.",
  ...
  },
  {
    ...
    caseLabel: 'CASE FILE: MALIBU',
    x: 14, y: 33,
    xPortrait: 14, yPortrait: 30,
    showLabel: true,
    headline: 'DOWNLOADS.',
    body: "Wallpapers. Icons. Case file stamps. Pieces of the world for your world.",
    cta: { label: 'UNLOCK', href: '/vault' },
    extras: [
      { label: '🔒 Collect 3 spider-hearts to unlock bonus files.' },
    ],
  ...
  },
  {
    ...
    caseLabel: 'CASE FILE: INGLEWOOD',
    x: 45, y: 82,
    xPortrait: 42, yPortrait: 60,
    showLabel: true,
    headline: 'DRESS ME UP.',
    body: "The closet on the floor. Pick the version of me you want.\n\nEvery outfit is a different confession ♥",
    cta: { label: 'PLAY' },
  ...
  },
  {
    ...
    caseLabel: 'CASE FILE: LAX',
    x: 38, y: 92,
    xPortrait: 40, yPortrait: 76,
    showLabel: true,
    headline: 'GET THE DROP FIRST.',
    body: "Before the world knows. Before the algorithm decides. You get it here.\n\nThe terminal bar still has the table in the corner. Six songs, six features. Play the record out.",
  ...
  },
  {
    id: 'long-beach',
    name: 'Long Beach',
    neighborhood: 'Archive / SoundCloud',
    caseLabel: 'CASE FILE: LONG BEACH',
    x: 75, y: 88,
    xPortrait: 52, yPortrait: 92,
    headline: 'RAW ARCHIVE.',
    body: "Demos. Alternates. Behind-the-world moments. The stuff that wasn't supposed to survive.",
    cta: { label: 'LISTEN' },
    ...
    embeds: [
      { type: 'soundcloud', url: 'https://w.soundcloud.com/player/?url=https%3A//soundcloud.com/trulyoung&color=%23ff5500&auto_play=false&hide_related=true&show_comments=false&show_user=true&show_reposts=false&show_teaser=false&visual=true', title: 'SoundCloud Archive' },
    ],
  },
];
