...
// Archipelago world — per-district islands (generated separately) composited by
// Python onto a full neon-noir LA basin so the gaps read as one cohesive map.
const MAP_SRC = "/world/maps/la-archipelago.jpg";
const MAP_W = 3600, MAP_H = 2400;
const MAP_SRC_P = "/world/maps/la-archipelago-v.jpg";
const MAP_W_P = 1600, MAP_H_P = 2200;
...
const WAYPOINTS: Waypoint[] = [
  // x/y = % on la-archipelago.jpg (landscape); xP/yP = % on la-archipelago-v.jpg
  // (portrait). Generated by scratchpad/world.py from the island composite.
  { id: "laurel-canyon", name: "Laurel Canyon", blurb: "Songbook", x: 44.2, y: 8.2, xP: 53.6, yP: 5.2, labelBelowP: true },
  { id: "weho", name: "West Hollywood", blurb: "Merch", x: 27.5, y: 20.5, xP: 26.2, yP: 14.6, labelBelowP: true },
  { id: "hollywood", name: "Hollywood", blurb: "Music / Releases", x: 42.0, y: 19.8, xP: 50.0, yP: 14.0 },
  { id: "silverlake", name: "Silver Lake", blurb: "The Inner Circle", x: 68.5, y: 24.0, xP: 74.0, yP: 24.0 },
  { id: "dtla", name: "Downtown", blurb: "Cruise Night", x: 85.0, y: 45.4, xP: 73.0, yP: 44.5 },
  { id: "lax", name: "LAX", blurb: "Get the Drop", x: 47.0, y: 86.0, xP: 40.0, yP: 81.0, labelBelowP: true },
  { id: "santa-monica", name: "Santa Monica", blurb: "Live / Sessions", x: 17.6, y: 68.6, xP: 27.0, yP: 55.9, labelBelowP: true },
  { id: "venice", name: "Venice", blurb: "Videos", x: 26.4, y: 75.7, xP: 41.6, yP: 61.6, labelBelowP: true },
  { id: "malibu", name: "Malibu", blurb: "Downloads", x: 4.4, y: 64.3, xP: 5.3, yP: 52.5, labelBelowP: true },
  { id: "beverly-hills", name: "Beverly Hills", blurb: "Press / EPK", x: 33.6, y: 42.8, xP: 25.5, yP: 32.0, labelBelowP: true },
  { id: "koreatown", name: "Koreatown", blurb: "After Hours", x: 50.4, y: 45.9, xP: 54.5, yP: 34.6 },
  { id: "the-valley", name: "The Valley", blurb: "The Lore", x: 33.2, y: 4.5, xP: 35.6, yP: 2.3 },
  { id: "inglewood", name: "Inglewood", blurb: "Dress-Up", x: 58.5, y: 66.6, xP: 62.0, yP: 66.8, labelBelowP: true },
  { id: "long-beach", name: "Long Beach", blurb: "Raw Archive", x: 85.0, y: 86.5, xP: 70.0, yP: 89.4, labelBelowP: true },
];
...
const MapHub: React.FC = () => {
  ...
  const CAMS: { label: string; fx: number; fy: number; z: number }[] = [
    { label: "Wide", fx: 50, fy: 46, z: 1 },
    { label: "Hills", fx: 45, fy: 16, z: 1.7 },
    { label: "Coast", fx: 20, fy: 72, z: 1.7 },
    { label: "Downtown", fx: 82, fy: 48, z: 1.8 },
  ];
